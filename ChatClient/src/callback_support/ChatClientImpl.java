...
/**
 * 
 * The implementation of the chat room client interface
 * Extends UnicastRemoteObject to communicate with the remote object ChatRoomImpl
 */
...
public class ChatClientImpl extends UnicastRemoteObject implements ChatRoomClientInterface {
    ...
    /**
    *
    * @param messages the text area where the general chat is displayed for the specific client
    * @param userList a list model to display active users for the specific client
    * @param privateMsg the text area where private messages are displayed for the specific client
